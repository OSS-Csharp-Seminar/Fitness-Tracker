        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Messages_AspNetUsers_TrainerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserPhysiques", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserPhysiques_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrainingDuration = table.Column<TimeOnly>(type: "TEXT", nullable: false),
                    TrainingDays = table.Column<int>(type: "INTEGER", nullable: false),
                    WorkoutPlanType = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Trenings_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Trenings_WorkoutPlans_WorkoutPlanId",
            ...
            migrationBuilder.CreateTable(
                name: "TreningWorkouts",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    TreningId = table.Column<Guid>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TreningWorkouts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TreningWorkouts_Trenings_TreningId",
                        column: x => x.TreningId,
                        principalTable: "Trenings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TreningWorkouts_Workouts_WorkoutId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Trenings_UserId",
                table: "Trenings",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Trenings_WorkoutPlanId",
                table: "Trenings",
                column: "WorkoutPlanId");

            migrationBuilder.CreateIndex(
                name: "IX_TreningWorkouts_TreningId",
                table: "TreningWorkouts",
                column: "TreningId");

            migrationBuilder.CreateIndex(
                name: "IX_TreningWorkouts_WorkoutId",
                table: "TreningWorkouts",
                column: "WorkoutId");

            migrationBuilder.CreateIndex(
                name: "IX_UserPhysiques_UserId",
                table: "UserPhysiques",
                column: "UserId");
